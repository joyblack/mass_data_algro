...
// 1.Check input arg length must be 2.
//        if(args.length < 2){
//            System.out.println("Please set 2 arg: movie input path and output path...");
//            System.exit(-1);
//        }
        ...
        JavaPairRDD<String, Tuple2<String, Integer>> moviesRDD = firstRDD.mapToPair(
                line -> {
                    // 解析列
                    String[] tokens = line.split(MyConfig.COL_SEPARATOR);
        ...
        JavaPairRDD<
            ...
            Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer> value = new Tuple7<>(
                    ...
                    m1._2() * m1._2(), // sqrt of m1.score
                    m2._2() * m2._2() // sqrt of m2.score
            );
